...
use Symfony\Component\Security\Core\Security as Security_auth;
...
class UsersAuthenticator extends AbstractLoginFormAuthenticator
{
    ...
    public function authenticate(Request $request): Passport
    {
        ...
        $request->getSession()->set(Security_auth::LAST_USERNAME, $email);
    ...
    /* #[Security("is_granted('S_AUTHENTICATED_FULLY')")]
